...
int TraCICommandInterface::Vehicle::slowDown(double speed, int32_t time) {
...
double TraCICommandInterface::Vehicle::getLength(std::string nodeId) {
...
/////////////////////////////////////////
//double TraCICommandInterface::Lane::getMinSpeed(std::string l_id) {
//   return traci->genericGetDouble(CMD_GET_LANE_VARIABLE, l_id, VAR_MINSPEED, RESPONSE_GET_LANE_VARIABLE);
//}
/////////////////////////////////////////
...
/////////////////////////////////////
double TraCICommandInterface::Lane::getMeanSpeed(std::string l_id) {
    return traci->genericGetDouble(CMD_GET_LANE_VARIABLE, l_id, LAST_STEP_MEAN_SPEED, RESPONSE_GET_LANE_VARIABLE);
}
